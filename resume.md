...
Github: [github.com/rdshoep](https://github.com/rdshoep)
...
系统完全由Javascript实现，由本人快速设计实现。针对中南海香烟调研而扩展出来的复杂通用版本。
...
后期引入Reactjs，替代发活动、活动管理等复杂应用界面，支持服务器渲染和资源按需加载。
...
1. 针对alioss的扩展支持([alioss-upload](https://rdshoep.github.io/alioss-upload/)、ossStsServer、[ghost-storage-alioss](https://rdshoep.github.io/ghost-storage-alioss/))
